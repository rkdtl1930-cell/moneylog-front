...
export default function Home() {
  ...
  const faq = [
    ["회원가입은 꼭 해야 하나요?", "기본 회원가입은 꼭 해야 하나요?답변"],
    ["데이터는 챗봇 입력은 무료인가요?", "챗봇 입력은 무료인가요? 답변답변."],
    ["소비 데이터는 안전한가요? 챗봇 입력은 무료인가요??", "소비 데이터는 안전한가요? 답변답변."],
    ["가계부 내역은 수정 가능한가요?", "가계부 내역은 수정 가능한가요? 답변답변."],
  ];
    ...
    <main id="main">
      <section className="sc01">
        <div className="fix-layout">
          <h1>ONE CHAT.<br/>EASY MONEY</h1>
          <p>입력 없이, 대화로 소비를 기록하세요</p>
          <a href="" className="yellowBtn">Try for Free</a>
        </div>
      </section>
      <section className="sc02">
        <h2 className="mainTit">
          입력 없이, 고민 없이<br/>챗봇과의 대화로 소비를 기록하고 정리하세요.
        </h2>
        <ul>
          <li>
            <i>
      ...
      <section className="sc06">
        <h2 className="mainTit">
          가계부를 포기했던 사람들이<br/>다시 기록을 시작했습니다
        </h2>
      ...
      <section className="sc07">
        <div className="con">
            <h2 className="mainTit">
            써보는 게 가장 빠릅니다.<br/>단 한마디로 시작하세요
          </h2>
          <button className="yellowBtn">챗팅 시작</button>    
        </div>
      </section>
    </main>
    <Footer/>
